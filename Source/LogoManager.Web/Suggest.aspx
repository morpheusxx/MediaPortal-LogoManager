...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
        <ajaxToolkit:TabPanel ID="tabPanelNewChannel" runat="server" HeaderText="Suggest new Channel">
            <ContentTemplate>
            ...
            <ContentTemplate>
                <asp:UpdatePanel ID="UpdatePanelChannelSearch" runat="server">
                    <ContentTemplate>
                        <table>
                            <tr>
                                <td><asp:TextBox ID="tbxChannelSearch" runat="server" Width="200px" /></td>
    ...
    <table style="width:100%">
        ...
        <tr>
            <td>File</td>
            <td>
                <asp:FileUpload ID="uploadLogoFile" runat="server" /></td>
        </tr>
    </table>
    </div>
